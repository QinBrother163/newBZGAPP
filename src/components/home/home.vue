    ...
    <div id="home">
        ...
        >
            <div>
                ...
                <div class="typeBlock">
                    <router-link tag="div" class="tb_list_item" to="#">
                        <p class="icon-little"></p>
                        <p class="icon-text">热门新车</p>
                    </router-link>

                    <router-link tag="div" class="tb_list_item" to="#">
                        <p class="icon-little"></p>
                        <p class="icon-text">最新上架</p>
                    </router-link>

                    <router-link tag="div" class="tb_list_item" to="#">
                        <p class="icon-little"></p>
                        <p class="icon-text">二手靓车</p>
                    </router-link>

                    <router-link tag="div" class="tb_list_item" to="#">
                        <p class="icon-little"></p>
                        <p class="icon-text">购车攻略</p>
                    </router-link>
                </div>
                ...
                <div class="recommend">
                    ...
                    <div class="recommendLists">
                        <div v-cloak class="item" v-for="(item,index) in recommendLists" :key="index" @click="toProductDetail(item.price)">
...
export default {
  ...
  methods: {
        ...
        let arr = [
            {
                ...
                imgUrl:'http://yuanying.zsbzg.net/carImage/2018-07-05/ddabcfb1a1b74e079071a69eeee44aff.png',
                price:'43000000'
            },
            {
                title:'奥迪 雅阁 进口 2018新款 超级定制版',
    ...
    //   this.$axios
    //     .get("/product/getRecommenProduct", {
    //       params: {
    ...
    _getBannerAds() {
      this.$axios
        .get("/advertise/getIndexAdvertiseImage")
        .then(res => {
          //  console.log(res)
          if (res.status === 200) {
            if (res.data.code > 0) {
...
#home {
  ...
  .typeBlock {
    ...
    display: flex;
    text-align: center;
    padding: px2rem(16) 0 px2rem(26) 0;
    ...
    .tb_list_item {
      ...
      .icon-little {
        ...
        background-size: px2rem(444);
        background-position: px2rem(-140) px2rem(-5); 
      }
