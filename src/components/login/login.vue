    ...
    <div class="login">
        ...
        <!-- <div class="input-group">
            ...
            <div class="verificationCode-container">
                <getPhoneCode  @getCode="getCode" @toast="toast"></getPhoneCode>
            </div>
           
        </div> -->
         <div class="input-group">
            <label for="password" class="input_label">密码</label>
            <input type="password" id="password" class="input" placeholder="请输入6位以上的密码" v-model="password" autocomplete="off">
             <!-- <div class="feedback-container">
                <login-validate :showType="passFeedBackType" :errorMsg="passErrorMsg"></login-validate>
            </div> -->
        </div>
        <div class="confirm-container">
            <div class="confirm-btn" :class="{active: isReady}" @click="tologin">登录</div>
        </div>
        <div class="foot">
            <router-link tag="div"  to="/login/resetPassword">忘记密码？</router-link>
            <router-link tag="div"  to="/login/register">注册</router-link>
        </div> 
        <!-- <router-link tag="div" class="forgetPassword" to="/login/resetPassword">忘记密码？</router-link>
        <router-link tag="div" class="register" to="/login/register">注册</router-link> -->
